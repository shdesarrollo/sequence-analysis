...
<div class="container">
  ...
  <div class="card border-primary mb-12">
    <div class="card-header text-white text-center bg-primary"><strong>ALINEAMIENTO LOCAL</strong></div>
    <div class="card-body">
      <form action="index.php?pid=<?php echo base64_encode("./Controlador/controladorLocal.php")?>" enctype="multipart/form-data" method="post">
        <!-- Secuencias -->
        <div class="row">
        ...
        <div class="row">
          <div class="col-sm-1" style="margin-top: 6px;">
            <span class="badge badge-success">SECUENCIA 1</span>
          </div>
          <div class="form-group col-sm-2">
            <div class="input-group">
              <div class="input-group-prepend">
