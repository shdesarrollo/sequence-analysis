...
<div class="container">
  ...
  <div class="card border-primary mb-12">
    <div class="card-header text-white text-center bg-primary"><strong>ALINEAMIENTO GLOBAL</strong></div>
    <div class="card-body">
      <form action='index.php?pid=<?php echo base64_encode("./Controlador/controladorGlobal.php")?>' enctype="multipart/form-data" method="post">
        <div class="row">
